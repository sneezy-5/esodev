...
@if ($errors->any())
                      ...
                      <label for="exampleSelectGender">Catégorie</label>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="nom du produit" name="title">
							</div>
						</div>
            ...
            <div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="prix du produit" name="price">
							</div>
						</div>
						<div class="form-group">
            ...
            <div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="stock disponible" name="stock">
							</div>
						</div>
            ...
            <div class="form-check">
                  ...
                  <div class="form-group sale_price" style="display: none;">
                    ...
                    <input type="number" class="form-control" id="exampleInputPassword1" placeholder="prix" name="sale_price">
                  </div>
